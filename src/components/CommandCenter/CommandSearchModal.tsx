...
const proActionByCenter:Record<string,string>={
  TEXT:"SMART_TEXT_CENTER",BLOCK_FIELD:"SMART_TEXT_CENTER",FIELD:"FIELD_DOCTOR_CENTER",
  GEOMETRY:"GEOMETRY_TOOL_CENTER",DIMENSION:"QUICK_DIM_CENTER",QUANTITY:"QUANTITY_CENTER",
  CEILING:"QUANTITY_CENTER",LAYOUT:"LAYOUT_AUTOMATION_CENTER",TOOLS:"OPEN_2D_PRO_CENTER"
};
