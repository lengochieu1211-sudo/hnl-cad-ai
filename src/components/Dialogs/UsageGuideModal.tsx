...
const items:HelpItem[] = [
  ...
  {id:"SU_TO_CAD",title:"SketchUp → CAD 2D",category:"SKETCHUP",status:"PARTIAL",risk:"HIGH",
   purpose:"Lấy Scene/Section từ SketchUp, chiếu thành linework 2D để chỉnh tiếp trong HNL/AutoCAD và Publish.",prerequisites:["Cài HNL CAD AI Bridge v2.8.1.rbz trong SketchUp.","Nên chọn Parallel Projection và Scene/Section rõ ràng."],
