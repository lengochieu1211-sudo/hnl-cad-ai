...
const items:HelpItem[] = [
  {id:"START",title:"Bắt đầu & quản lý dự án",category:"CƠ BẢN",status:"READY",risk:"LOW",
   ...
   steps:["Mở Start Center.","Chọn Tiếp tục / Mở DWG bằng AutoCAD + HNL / Mở DXF-Dự án HNL / Bản vẽ mới.","DWG nâng cao được thu gọn dưới Tùy chọn DWG nâng cao.","Theo dõi dấu ● cạnh tên file: có dấu nghĩa là chưa lưu.","Ctrl+S để lưu; nên Save As trước khi Cleanup hoặc chuyển đổi lớn."],
  ...
  {id:"PRO2D",title:"2D Professional + 44 Lisp nguồn",category:"CAD 2D",status:"PARTIAL",risk:"MEDIUM",
   ...
   prerequisites:[
    ...
    "Installer + AutoCAD plugin đã tích hợp 44 Lisp từ AI.rar. Mặc định ON-DEMAND: chỉ Lisp đang dùng mới được LOAD, tránh nặng AutoCAD.",
   ...
   steps:[
    ...
    "Muốn chạy Lisp cũ: chọn đúng Lisp rồi Nạp + Chạy; HNL chỉ LOAD file cần dùng. HNLLISPRELOAD chỉ dùng khi bạn chủ động muốn nạp toàn bộ 44 Lisp.",
    ...
    "Nếu Lisp có nhiều command (QQ/QED/QE/...): Nạp trước, sau đó gõ đúng command cần dùng trên AutoCAD Command Line.",
    "Nếu Unknown command: kiểm tra LOAD có lỗi không, file có đúng command không, dependency/DCL có thiếu không.",
    "Nếu SECURELOAD chặn: thêm thư mục vào Trusted Locations trong AutoCAD Options > Files > Trusted Locations, rồi nạp lại.",
    "Nếu thao tác làm sai geometry/Field/Layout: Undo ngay, không Save đè file gốc, xuất Diagnostics và chụp Command Line AutoCAD."
   ],
   ...
   errors:[
    ...
    "DCL load failed: Lisp dùng file .dcl ngoài nhưng file phụ không có/đường dẫn sai.",
    "Excel/COM lỗi: một số Lisp cần Microsoft Excel/Visual LISP COM.",
    "Selection nil/Chưa chọn đối tượng: làm theo prompt AutoCAD và chọn đúng loại entity.",
  ...
  {id:"SU_TO_CAD",title:"SketchUp → CAD 2D",category:"SKETCHUP",status:"PARTIAL",risk:"HIGH",
   purpose:"Lấy Scene/Section từ SketchUp, chiếu thành linework 2D để chỉnh tiếp trong HNL/AutoCAD và Publish.",prerequisites:["Cài HNL CAD AI Bridge v2.7.12.rbz trong SketchUp.","Nên chọn Parallel Projection và Scene/Section rõ ràng."],
