...
export default function App() {
  ...
  const saveProjectJson = useCallback(async () => {
    ...
    const payload=JSON.stringify({version:"2.4.1",schemaVersion:2,savedAt:new Date().toISOString(),currentFileName,activeLayoutId:activeLayout?.id||null,entities,layers,layouts,viewports,smartObjects,spreadsheetParameters,translationMemory,blockLibrary,dependencyEdges,modules,selectedWorkbench},null,2);
    const base=currentFileName.replace(/\.[^.]+$/,"")||"BanVe_HNL";
          ...
          <div className="w-full max-w-5xl rounded-2xl border border-neutral-700/80 bg-[#16181c] shadow-2xl overflow-hidden">
            <div className="px-8 py-7 border-b border-neutral-800 bg-gradient-to-r from-[#15181c] to-[#101820] flex items-center justify-between gap-6">
              <div>
                ...
                <h1 className="mt-2 text-2xl font-bold text-white">HNL CAD AI <span className="text-cyan-400">v2.4.1</span></h1>
