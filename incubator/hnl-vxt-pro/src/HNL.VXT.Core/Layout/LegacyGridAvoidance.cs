...
namespace HNL.VXT.Core.Layout
{
    ...
    internal static class LegacyGridAvoidance
    {
            ...
            double increment)
        {
            ...
            // Preserve the phase generated by SmartLayout/fixed-layout rather than snapping to
            // the global WCS origin. All final repaired coordinates therefore differ from this
            // origin by an integer multiple of the configured increment.
            var gridOrigin = x[0];
            ...
            while (changed && iteration < MaxIterations)
            {
                ...
                // HNL correction: "multiple-aligned" means aligned to this ceiling grid phase.
