...
namespace HNL.VXT.Core.Preview
{
    ...
    /// Each candidate is solved by the normal Pro builder. "Thêm XC cạnh khuyết" is local-add
    /// only: it may add required short XC but never rebalance or replace the base XC grid.
    ///
